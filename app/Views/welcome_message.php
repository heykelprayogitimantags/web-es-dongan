...
<head>
   ...
   <link rel="shortcut icon" type="image/png" href="<?= base_url('uploads/logo.png?v=2'); ?>">
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        header .logo {
            ...
            height: 44px;
            padding: .4rem .5rem;
            display: flex;       /* Tambahan agar logo pas di tengah */
            align-items: center; /* Tambahan agar logo pas di tengah */
        }
        header .menu-toggle {
            display: none;
            float: right;
...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo">
                <a href="<?= base_url() ?>">
                    <img src="<?= base_url('uploads/logo.png'); ?>" alt="Logo Es Dongan" style="height: 40px; width: auto;">
                </a>
            </li>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang di Es Dongan</h1>

        <h2>Minumannya Kawan Awak</h2>
...
<section>
    ...
    <p>Halaman yang kamu lihat ini digenerate secara dinamis oleh CodeIgniter.</p>

    <p>Jika kamu ingin mengedit halaman ini, lokasinya ada di:</p>

    <pre><code>app/Views/welcome_message.php</code></pre>

    <p>Controller yang mengatur halaman ini ada di:</p>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> Es Dongan. All Rights Reserved.</p>
