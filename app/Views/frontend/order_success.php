    ...
    <div class="container mx-auto px-4 py-8 md:py-16 max-w-4xl">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-6 animate-slide-up border border-gray-100">
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    <!-- Di bagian order items, ganti dengan: -->
                    <?php
                    $items = $cart; // Karena kita pakai variabel $cart
                    $orderTotal = $total;
                    ...
                    ?>
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            ...
                            <p class="font-semibold text-cyan-600">Rp <?= number_format($subtotal, 0, ',', '.') ?></p>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <!-- Payment Summary -->
            <div class="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-4 md:p-6">
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-gray-200">
                        ...
                        <span class="bg-white px-3 py-1.5 rounded-lg font-semibold text-sm text-gray-800 shadow-sm">
