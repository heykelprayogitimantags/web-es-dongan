...
<body class="bg-gradient-to-br from-blue-50 via-cyan-50 to-purple-50 min-h-screen">
        ...
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex justify-between items-center py-5">
                <a href="/" class="flex items-center space-x-3 group">
                    <div class="relative">
                        <div class="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full blur opacity-75 group-hover:opacity-100 transition"></div>
                    ...
                    <div>
                        <span class="text-2xl font-bold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">Toko Es Dongan</span>
                        <p class="text-xs text-gray-500">Minumannya Kawan Awak</p>
                    </div>
                </a>
                <a href="/" class="flex items-center gap-2 text-cyan-600 hover:text-cyan-700 font-semibold px-4 py-2 rounded-lg hover:bg-cyan-50 transition-all">
    ...
    <div class="container mx-auto px-4 lg:px-8 py-8 lg:py-12">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent mb-2">
                Keranjang Belanja
            </h1>
            <p class="text-gray-600">Kelola pesanan Anda dengan mudah</p>
        </div>

        <?php if (session()->getFlashdata('success')): ?>
            <div class="bg-green-50 border-l-4 border-green-500 text-green-700 p-4 mb-6 rounded-lg shadow-lg" role="alert">
        ...
        <?php if (empty($cart)): ?>
            <div class="glass-effect rounded-2xl shadow-2xl p-12 lg:p-16 text-center">
                ...
                <h3 class="text-3xl font-bold text-gray-700 mb-3">Keranjang Masih Kosong</h3>
                <p class="text-gray-500 mb-8 text-lg">Yuk mulai belanja dan nikmati kesegaran es pilihan terbaik!</p>
                <a href="/" class="btn-primary inline-block bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-4">
                    <?php foreach ($cart as $item): ?>
                        <div class="cart-item glass-effect rounded-2xl shadow-lg overflow-hidden">
                            <div class="flex flex-col md:flex-row items-center gap-6 p-6">
                                <!-- Product Image -->
                                <div class="relative group">
                                    <div class="w-28 h-28 ice-gradient rounded-2xl flex items-center justify-center overflow-hidden shadow-md">
                                        <?php if ($item['image']): ?>
                                            <img src="/uploads/products/<?= $item['image'] ?>" alt="<?= $item['name'] ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                                        <?php else: ?>
                                            <svg class="w-16 h-16 text-cyan-500" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div class="flex-1 text-center md:text-left">
                                    ...
                                    <div class="flex items-center gap-2 justify-center md:justify-start">
                                        <span class="text-sm text-gray-500 line-through">Rp <?= number_format($item['price'] * 1.2, 0, ',', '.') ?></span>
                                ...
                                <div class="flex flex-col items-center gap-3">
                                    <form action="/cart/update" method="post" class="flex items-center gap-3">
                                        ...
                                        <div class="flex items-center bg-gray-100 rounded-xl overflow-hidden">
                                            <button type="button" onclick="this.nextElementSibling.stepDown()" class="px-4 py-2 text-gray-600 hover:bg-gray-200 transition">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4" />
                                                </svg>
                                            </button>
                                            <input type="number" name="quantity" value="<?= $item['quantity'] ?>" min="1"
                                                class="quantity-input w-16 px-3 py-2 text-center font-semibold bg-transparent border-0 focus:outline-none">
                                            <button type="button" onclick="this.previousElementSibling.stepUp()" class="px-4 py-2 text-gray-600 hover:bg-gray-200 transition">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                                </svg>
                                            </button>
                                        </div>
                                        <button type="submit" class="bg-cyan-600 text-white px-5 py-2 rounded-xl hover:bg-cyan-700 font-medium shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5">
                                            Update
                                        </button>
                                    </form>
                                </div>
                ...
                <div class="lg:col-span-1">
                    <div class="glass-effect rounded-2xl shadow-2xl p-6 lg:p-8 sticky top-24">
                        <div class="flex items-center gap-3 mb-6 pb-6 border-b border-gray-200">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800">Ringkasan Belanja</h3>
                        </div>
                        ...
                        <div class="space-y-4 mb-8">
                            ...
                            <div class="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-5 mt-6">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="badge-count w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                                        <?= count($cart) ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a href="/checkout" class="btn-primary block w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-center py-4 rounded-xl font-bold text-lg hover:from-cyan-600 hover:to-blue-700 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all">
